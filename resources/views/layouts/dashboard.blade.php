    ...
    <div class="flex min-h-screen">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
            ...
            <div class="h-16 sm:h-20 flex items-center gap-3 px-5 border-b border-slate-100">
                <div class="w-9 h-9 rounded-full brand-gradient flex items-center justify-center shrink-0">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="white"><path d="M12 2C12 2 5 11.5 5 16a7 7 0 0014 0C19 11.5 12 2 12 2z"/></svg>
                </div>
